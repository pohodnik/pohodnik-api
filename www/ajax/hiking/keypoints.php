...
$q = $mysqli->query("SELECT `id`, `name`, `desc`, UNIX_TIMESTAMP(`date_start`) AS d1, UNIX_TIMESTAMP(`date_finish`) AS d2, `lat`, `lon` FROM `hiking_keypoints` WHERE id_hiking={$id_hiking} ORDER BY date_start");
